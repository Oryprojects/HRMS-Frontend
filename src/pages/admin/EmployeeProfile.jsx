    ...
    if (editing) {
      try {
        ...
        const payload = {
          ...
          phoneNumber: form.mobile || employee?.phoneNumber || "",
          alternatePhone: form.alternateMobile || employee?.alternatePhone || "",
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-6">
              <div>
                ...
                <p className="text-brand-blue/60 font-medium tracking-tight mt-1">
            ...
            <div className="flex items-center gap-4">
                ...
                {isProfileDropdownOpen && (
                  <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-2xl shadow-2xl border border-brand-blue/5 py-2 z-[100] animate-in fade-in zoom-in duration-200 origin-top-right">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 text-sm font-bold text-brand-blue hover:bg-bg-slate transition-colors"
                    >
              ...
              <div className="flex items-center gap-3">
                {(userRole === "ADMIN" || userRole === "HR") && (
                  ...
                  >
                    {loading && editing ? "Saving..." : (editing ? "Save Profile" : "Edit Profile")}
                  </button>
                )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <aside className="lg:col-span-1 space-y-2">
              <div className="bg-white rounded-2xl p-4 shadow-sm border border-brand-blue/5">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-3xl shadow-xl border border-brand-blue/5 overflow-hidden">
                <div className="p-8">
                    ...
                    <div className="space-y-8">
                      <div className="flex flex-col md:flex-row items-center gap-8 pb-8 border-b border-gray-100">
                        ...
                        <div className="text-center md:text-left">
                          ...
                          <p className="text-brand-blue/40 font-bold uppercase tracking-widest text-xs mt-1">{form.role || "Designation"}</p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="md:col-span-2 space-y-2">
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <input name="firstName" value={form.firstName || ''} onChange={handleChange} disabled={!editing} className="w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all placeholder:text-brand-blue/20" placeholder="First Name" />
                            <input name="middleName" value={form.middleName || ''} onChange={handleChange} disabled={!editing} className="w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all placeholder:text-brand-blue/20" placeholder="Middle Name" />
                            <input name="lastName" value={form.lastName || ''} onChange={handleChange} disabled={!editing} className="w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all placeholder:text-brand-blue/20" placeholder="Last Name" />
                          </div>
                        </div>
                            ...
                            <div key={field.name} className="space-y-2">
                              ...
                              {isDropdown ? (
                                <select
                                  ...
                                  disabled={isDisabled}
                                  className={`w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${isDisabled ? 'opacity-60 cursor-not-allowed' : ''}`}
                                >
                        ...
                        <div className="space-y-2">
                          ...
                          <textarea name="currentAddress" value={form.currentAddress || ''} onChange={handleChange} disabled={!editing || userRole === 'ADMIN'} rows="2" className={`w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${(!editing || userRole === 'ADMIN') ? 'opacity-60 cursor-not-allowed' : ''}`} />
                        </div>
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-brand-blue/40 uppercase tracking-widest ml-1">Permanent Address</label>
                          <textarea name="permanentAddress" value={form.permanentAddress || ''} onChange={handleChange} disabled={!editing || userRole === 'ADMIN'} rows="2" className={`w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${(!editing || userRole === 'ADMIN') ? 'opacity-60 cursor-not-allowed' : ''}`} />
                        </div>
                      </div>
                    </div>
                  )}
                      ...
                      {[
                        ...
                        <div key={field.name} className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={handleChange}
                            disabled={!editing}
                            className={`w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${(!editing) ? 'opacity-60 cursor-not-allowed' : ''}`}
                          />
                        </div>
                      ))}
                      <div className="md:col-span-2 space-y-2">
                        <label className="text-xs font-bold text-brand-blue/40 uppercase tracking-widest ml-1">Address</label>
                        <textarea name="emergencyAddress" value={form.emergencyAddress || ''} onChange={handleChange} disabled={!editing} rows="3" className={`w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${(!editing) ? 'opacity-60 cursor-not-allowed' : ''}`} />
                      </div>
                    </div>
                  )}
                          ...
                          <div key={idx} className="bg-gray-50 p-6 rounded-2xl relative border border-brand-blue/5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="md:col-span-2 space-y-1">
                                ...
                                <textarea value={exp.employerAddress || ''} onChange={(e) => handleEmploymentChange(idx, 'employerAddress', e.target.value)} disabled={!editing} rows="2" className="w-full bg-white border-none rounded-lg px-3 py-2 text-sm font-bold text-brand-blue" />
                              </div>
                              <div className="space-y-1">
                                <label className="text-[10px] font-bold text-brand-blue/30 uppercase tracking-widest">Reporting Manager</label>
                                <input value={exp.reportingManagerName || ''} onChange={(e) => handleEmploymentChange(idx, 'reportingManagerName', e.target.value)} disabled={!editing} className="w-full bg-white border-none rounded-lg px-3 py-2 text-sm font-bold text-brand-blue" />
                              </div>
                              <div className="space-y-1">
                                <label className="text-[10px] font-bold text-brand-blue/30 uppercase tracking-widest">Manager Email</label>
                                <input value={exp.reportingManagerEmail || ''} onChange={(e) => handleEmploymentChange(idx, 'reportingManagerEmail', e.target.value)} disabled={!editing} className="w-full bg-white border-none rounded-lg px-3 py-2 text-sm font-bold text-brand-blue" />
                              </div>
                            </div>
                          </div>
                        ))}
                    ...
                    <div className="space-y-8">
                      <div className="bg-gray-50 rounded-2xl p-6 border border-brand-blue/5">
                        <div className="mb-6">
                          ...
                          <p className="text-xs text-brand-blue/40 font-medium">Verified academic records</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {[
                            ...
                            <div key={edu.id} className="bg-white p-4 rounded-xl border border-brand-blue/5 flex flex-col gap-3 shadow-sm relative group">
                              ...
                              <div className="h-[100px] flex items-center justify-center bg-gray-50 rounded-lg overflow-hidden border border-dashed border-brand-blue/10 relative cursor-pointer" onClick={() => uploadedFiles[edu.id] && window.open(uploadedFiles[edu.id].preview, '_blank')}>
                                {uploadedFiles[edu.id] ? (
                                  ...
                                  <span className="text-[10px] text-brand-blue/20 font-bold uppercase tracking-widest italic">Empty</span>
                                )}
                              </div>
                            </div>
                          ))}
                          <div className="bg-white p-4 rounded-xl border border-brand-blue/5 flex flex-col gap-3 shadow-sm">
                            <span className="text-sm font-bold text-brand-blue">Others / Miscellaneous</span>
                            {editing && (
                              <div className="flex gap-2">
                                <input placeholder="Document Name (e.g. Intern Letter)" className="flex-1 text-[11px] p-2 bg-gray-50 rounded-lg outline-none" value={otherEduLabel} onChange={(e) => setOtherEduLabel(e.target.value)} />
                        ...
                        <div key={cat} className="bg-white rounded-2xl p-6 border border-brand-blue/5 shadow-sm">
                          <div className="flex justify-between items-center mb-6">
                            <div>
                              ...
                              <p className="text-xs text-brand-blue/40 font-medium whitespace-nowrap overflow-hidden text-ellipsis">Manage {cat} certificates</p>
                            </div>
                            {editing && (
                  ...
                  {activeSection === 'leave_balance' && (
                    <div className="space-y-8">
                      <div className="mb-6">
                        ...
                        <p className="text-xs text-brand-blue/40 font-medium">Currently available leaves for this employee</p>
                      </div>
                      ...
                      {fetchingBalance ? (
                        ...
                        <div className="bg-gray-50 rounded-2xl p-12 text-center border border-dashed border-brand-blue/10">
                          ...
                          <button
                            ...
                            className="mt-4 px-6 py-2 bg-brand-blue text-white font-bold rounded-xl hover:bg-brand-blue-hover transition-all text-sm"
                          >
                            Initialize Balance
                          </button>
                        </div>
